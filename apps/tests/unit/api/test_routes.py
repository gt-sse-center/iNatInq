...
The tests cover:
  ...
  - Process endpoint (/process) for Ray job submission
  - Spark job management endpoints (/spark/jobs/*)
...
# =============================================================================
# Process Endpoint Tests (Ray Jobs)
# =============================================================================


# =============================================================================
# Spark Job Management Endpoints Tests
# =============================================================================


class TestSparkJobEndpoints:
    """Test suite for /spark/jobs/* endpoints."""

    def test_submit_spark_job_success(
        self,
        test_client: TestClient,
        ...
        **Why this test is important:**
          - Validates Spark job submission flow
          - Tests SparkService integration
          - Ensures proper response format
        """
        with patch(
            "api.routes.SparkService",
            return_value=mock_spark_service,
        ):
        ...
        data = response.json()
        assert data["job_name"] == "s3-to-vector-db-20260112-153045-a1b2c3d4"
        assert data["status"] == "submitted"

    def test_get_spark_job_status_success(
        self,
        test_client: TestClient,
        mock_spark_service: MagicMock,
    ) -> None:
        """Test getting Spark job status.
        ...
        **Why this test is important:**
        ...
        with patch(
            ...
            response = test_client.get("/spark/jobs/s3-to-vector-db-20260112-153045-a1b2c3d4")
    ...
    def test_list_spark_jobs_success(
        self,
        test_client: TestClient,
        mock_spark_service: MagicMock,
    ) -> None:
        """Test listing all Spark jobs.

        **Why this test is important:**
          - Validates job list retrieval
          - Tests SparkService integration
        """
        with patch(
            "api.routes.SparkService",
            ...
            response = test_client.get("/spark/jobs")
    ...
    def test_delete_spark_job_success(
        self,
        test_client: TestClient,
        mock_spark_service: MagicMock,
    ) -> None:
        """Test deleting a Spark job.

        **Why this test is important:**
          - Validates job deletion
          - Tests SparkService integration
        """
        with patch(
            "api.routes.SparkService",
            ...
            response = test_client.delete("/spark/jobs/s3-to-vector-db-20260112-153045-a1b2c3d4")
