"""Databricks entrypoint for S3 Auto Loader Bronze ingestion."""
...
def _entrypoint_file() -> str:
    ...
    return globals().get("__file__") or (sys.argv[0] if sys.argv else "run_ingest_s3_autoloader.py")
...
if __name__ == "__main__":
    ...
    from core.ingestion.databricks.process_s3_autoloader import main
