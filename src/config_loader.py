...
YAML_TO_ENV_MAP: dict[str, str] = {
    ...
    "vector_databases.weaviate.url": "WEAVIATE_URL",
    "vector_databases.weaviate.api_key": "WEAVIATE_API_KEY",
    "vector_databases.weaviate.grpc_host": "WEAVIATE_GRPC_HOST",
    "vector_databases.weaviate.grpc_port": "WEAVIATE_GRPC_PORT",
    "vector_databases.weaviate.timeout_seconds": "WEAVIATE_TIMEOUT",
    "vector_databases.weaviate.circuit_breaker.failure_threshold": "WEAVIATE_CIRCUIT_BREAKER_THRESHOLD",
    "vector_databases.weaviate.circuit_breaker.recovery_timeout": "WEAVIATE_CIRCUIT_BREAKER_TIMEOUT",
    # Embeddings
    "embeddings.provider": "EMBEDDING_PROVIDER",
    "embeddings.vector_size": "EMBEDDING_VECTOR_SIZE",
    "embeddings.ollama.url": "OLLAMA_BASE_URL",
    "embeddings.ollama.model": "OLLAMA_MODEL",
    "embeddings.ollama.timeout_seconds": "OLLAMA_TIMEOUT",
    "embeddings.ollama.max_batch_size": "OLLAMA_MAX_BATCH_SIZE",
    "embeddings.ollama.circuit_breaker.failure_threshold": "OLLAMA_CIRCUIT_BREAKER_THRESHOLD",
    "embeddings.ollama.circuit_breaker.recovery_timeout": "OLLAMA_CIRCUIT_BREAKER_TIMEOUT",
    ...
    "ray.rate_limits.ollama_max_concurrency": "RAY_OLLAMA_MAX_CONCURRENCY",
    "ray.rate_limits.ollama_requests_per_second": "RAY_OLLAMA_RPS",
