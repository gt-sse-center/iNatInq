...
class TestResolveSearchPipeline:
    ...
    @patch("core.benchmark.provider_factory.CLIPClient")
    @patch("core.benchmark.provider_factory.VectorDBConfig")
    @patch("core.benchmark.provider_factory.ImageEmbeddingConfig")
    @patch("core.benchmark.provider_factory.create_vector_db_provider")
    def test_qdrant_provider_creates_pipeline(
        self,
        mock_create_vdb,
        mock_img_config_cls,
        mock_vdb_config_cls,
        ...
        mock_vdb_config_cls.from_env.return_value = mock_vdb_config
        mock_provider = MagicMock()
        mock_create_vdb.return_value = mock_provider

        mock_img_config = MagicMock()
        mock_img_config_cls.from_env.return_value = mock_img_config
    ...
    @patch("core.benchmark.provider_factory.ImageEmbeddingConfig")
    @patch("core.benchmark.provider_factory.create_vector_db_provider")
    def test_qdrant_passes_collection_to_config(
        self,
        mock_create_vdb,
        mock_img_config_cls,
        mock_vdb_config_cls,
        ...
        mock_img_config_cls.from_env.return_value = MagicMock()
