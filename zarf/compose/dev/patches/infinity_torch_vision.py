...
#
# PATCHED: Guard config.architectures access for SigLIP2 models
# that don't include the architectures field in their config.
# Original bug: config.architectures[0] crashes with TypeError when None.
# Upstream issue: infinity v0.0.77 torch_vision.py line 47.
...
class TIMM(BaseTIMM):
    ...
    def __init__(self, *, engine_args: "EngineArgs"):
        ...
        # PATCH: guard against None architectures (e.g. SigLIP2 models)
        self.is_colipali = (
            bool(config.architectures) and config.architectures[0] in IMAGE_COL_MODELS
        )
